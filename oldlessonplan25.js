...
const introPatterns = {
    english: {
        ...
        brainstorm: [
            (topic) => `introducing the lesson by asking questions about ${topic}`,
        ...
        checking: [
            () => `Checking whether student can respond accurately`,
            () => `Verifying the correctness of student responses`,
            () => `Assessing if student can answer correctly`,
    ...
    swahili: {
        ...
        brainstorm: [
            (topic) => `kutambulisha somo kwa kuuliza maswali kuhusu ${topic}`,
        ...
        studentResponseBrainstorm: [
            ...
            (topic) => `Wanafunzi kutoa majibu ya mdomo kuhusu ${topic}`,
            (topic) => `Wanafunzi kushiriki maoni yao kuhusu ${topic}`,
            (topic) => `Wanafunzi kujibu maswali yanayohusiana na ${topic}`
        ],
        
        
        checking: [
            () => `Kuangalia kama mwanafunzi anaweza kujibu kwa usahihi`,
            () => `Kuthibitisha usahihi wa majibu ya mwanafunzi`,
            () => `Kutathmini ikiwa mwanafunzi anaweza kujibu vizuri`,
            () => `Kuhakiki usahihi wa majibu ya mwanafunzi`
        ]
    }
};
...
const newKnowledgePatterns = {
    english: {
        ...
        assessment: [
            (action, topic) => `Checking if student can ${action} ${topic}`,
            (action, topic) => `Verifying whether student is able to ${action} ${topic}`,
    ...
    swahili: {
        teacher: [
            (action, topic) => `kuwaongoza wanafunzi ${action} ${topic}`,
            (action, topic) => `kuonyesha jinsi ya ${action} ${topic}`,
            (action, topic) => `kuwezesha wanafunzi ${action} ${topic}`,
            (action, topic) => `kuwaelekeza wanafunzi katika ${getVerbForm(action, 'noun', 'swahili')} wa ${topic}`
        ],
        student: [
            (action, topic) => `Wanafunzi kufanya kazi ya ${action} ${topic}`,
            (action, topic) => `Wanafunzi kujifunza jinsi ya ${action} ${topic}`,
            (action, topic) => `Wanafunzi kwa bidii ${action} ${topic}`,
            (action, topic) => `Wanafunzi kushiriki katika ${getVerbForm(action, 'noun', 'swahili')} wa ${topic}`
        ],
        assessment: [
            (action, topic) => `Kuangalia kama mwanafunzi anaweza ${action} ${topic}`,
            (action, topic) => `Kuthibitisha ikiwa mwanafunzi anaweza ${action} ${topic}`,
            (action, topic) => `Kutathmini uwezo wa mwanafunzi wa ${action} ${topic}`,
            (action, topic) => `Kuhakiki ${getVerbForm(action, 'noun', 'swahili')} wa mwanafunzi wa ${topic}`
        ]
    }
};
...
const reinforcementPatterns = {
    ...
    swahili: {
        teacher: [
            (action, topic) => `kuwaelekeza wanafunzi kwenye vikundi kujadili jinsi ya ${action} ${topic}`,
            (action, topic) => `kuandaa shughuli za kikundi za ${action} ${topic}`,
            (action, topic) => `kuwezesha kazi ya pamoja ya ${action} ${topic}`,
            (action, topic) => `kuratibu majadiliano ya vikundi kuhusu ${getVerbForm(action, 'noun', 'swahili')} wa ${topic}`
        ],
        student: [
            (action, topic) => `Wanafunzi kwenye vikundi kujadili njia za ${action} ${topic}`,
            (action, topic) => `Wanafunzi kushirikiana katika timu wakiwa ${action} ${topic}`,
...
const reflectionPatterns = {
    ...
    swahili: {
        teacher: [
            (action, topic) => `kuwauliza wanafunzi kuhusu changamoto waliozikumbana wakati wa ${action} ${topic}`,
            (action, topic) => `kuwahimiza wanafunzi kutafakari kuhusu ${getVerbForm(action, 'noun', 'swahili')} wa ${topic} katika mazingira halisi`,
            (action, topic) => `kuwasaidia wanafunzi kuunganisha ${action} ${topic} na hali za vitendo`,
            (action, topic) => `kuwahamasisha wanafunzi kuhusianisha ${getVerbForm(action, 'noun', 'swahili')} wao wa ${topic} na uzoefu wao`
        ],
        student: [
            (action, topic) => `Wanafunzi kutaja ugumu waliokutana nao wakati wa ${action} ${topic}`,
            (action, topic) => `Wanafunzi kushiriki jinsi wanavyoweza kutumia ${action} ${topic} katika hali halisi`,
            (action, topic) => `Wanafunzi kuhusianisha walichojifunza kuhusu ${action} ${topic} na maisha ya kila siku`,
            (action, topic) => `wanafunzi kuunganisha ${getVerbForm(action, 'noun', 'swahili')} wao wa ${topic} na mazingira ya vitendo`
        ],
        assessment: [
...
const consolidationPatterns = {
    ...
    swahili: {
        teacher: [
            (topic) => `kuuliza maswali machache na kufanya muhtasari wa somo kuhusu ${topic}`,
            (topic) => `kukagua vipengele muhimu na kuhitimisha somo kuhusu ${topic}`,
            (topic) => `kumalizia kwa maswali na muhtasari wa ${topic}`,
            (topic) => `kurudia dhana kuu za ${topic} kupitia maswali`
        ],
        student: [
            (topic) => `Wanafunzi kujibu maswali na kuandika nukuu fupi kuhusu ${topic}`,
            (topic) => `Wanafunzi kujibu maswali na kuandika vipengele muhimu kuhusu ${topic}`,
            (topic) => `Wanafunzi kushiriki katika ukaguzi na kuandika mawazo makuu kuhusu ${topic}`,
            (topic) => `wanafunzi kujibu maswali na kurekodi nukuu za muhtasari kuhusu ${topic}`
        ],
        assessment: [
            () => `Kuangalia kama mwanafunzi anaweza kujibu maswali kwa usahihi na kuandika nukuu`,
            () => `Kuthibitisha uwezo wa mwanafunzi wa kujibu vizuri na kupata vipengele muhimu`,
            () => `Kutathmini ikiwa mwanafunzi wanaweza kujibu vizuri na kuandika mawazo makuu`,
            () => `Kuhakiki majibu ya mwanafunzi na usahihi wa kuandika nukuu`
        ]
    }
};
const lessonCommentPatterns = {
    swahili: {
       
        allUnderstood: [
            (count, pct) => `somo limeelewekana vizuri na wanafunzi wote ${count} (${pct})`,
            (count, pct) => `wanafunzi wote ${count} (${pct}) wameelewa somo vizuri`,
            (count, pct) => `uelewa wa somo umekuwa mzuri kwa wanafunzi wote ${count} (${pct})`,
            (count, pct) => `somo limefikia malengo yake kikamilifu, wanafunzi wote ${count} (${pct}) wameelewa`,
            (count, pct) => `matokeo mazuri, wanafunzi ${count} (${pct}) wameelewa somo vizuri`
        ],
        
        oneMissing: [
            (understood, pctU, notUnd, pctN) => `somo limeeleweka na wanafunzi ${understood} (${pctU}) na mwanafunzi ${notUnd} (${pctN}) amepatiwa zoezi la ziada`,
            (understood, pctU, notUnd, pctN) => `wanafunzi ${understood} (${pctU}) wameelewa vizuri, mwanafunzi ${notUnd} (${pctN}) anapatiwa msaada wa ziada`,
            (understood, pctU, notUnd, pctN) => `uelewa mzuri kwa wanafunzi ${understood} (${pctU}), mwanafunzi ${notUnd} (${pctN}) anahitaji mazoezi zaidi`,
            (understood, pctU, notUnd, pctN) => `matokeo mazuri: wanafunzi ${understood} (${pctU}) wameelewa, mwanafunzi ${notUnd} (${pctN}) anatakiwa kufanya mazoezi mengine`,
            (understood, pctU, notUnd, pctN) => `somo limeelekana vizuri kwa wanafunzi ${understood} (${pctU}), lakini mwanafunzi ${notUnd} (${pctN}) anahitaji usaidizi zaidi`
        ],
        
        multipleMissing: [
            (understood, pctU, notUnd, pctN) => `somo limeeleweka na wanafunzi ${understood} (${pctU}) na wanafunzi ${notUnd} (${pctN}) wamepatiwa mazoezi ya ziada`,
            (understood, pctU, notUnd, pctN) => `wanafunzi ${understood} (${pctU}) wameelewa vizuri, wanafunzi ${notUnd} (${pctN}) wanapatiwa msaada wa ziada`,
            (understood, pctU, notUnd, pctN) => `uelewa mzuri kwa wanafunzi ${understood} (${pctU}), wanafunzi ${notUnd} (${pctN}) wanahitaji mazoezi zaidi`,
            (understood, pctU, notUnd, pctN) => `matokeo mazuri: wanafunzi ${understood} (${pctU}) wameelewa, wanafunzi ${notUnd} (${pctN}) watatakiwa kufanya mazoezi mengine`,
            (understood, pctU, notUnd, pctN) => `somo limeelekana vizuri kwa wanafunzi ${understood} (${pctU}), lakini wanafunzi ${notUnd} (${pctN}) wanahitaji usaidizi zaidi`,
            (understood, pctU, notUnd, pctN) => `wanafunzi wengi ${understood} (${pctU}) wamefanikiwa kuelewa, wanafunzi ${notUnd} (${pctN}) watapewa muda wa ziada wa kujifunza`
        ]
    },
    english: {
        
        allUnderstood: [
            (count, pct) => `lesson understood well by all ${count} students (${pct})`,
            (count, pct) => `all students ${count} (${pct}) demonstrated good understanding of the lesson`,
            (count, pct) => `excellent comprehension shown by all ${count} students (${pct})`,
            (count, pct) => `lesson objectives fully achieved, all ${count} students (${pct}) understood well`,
            (count, pct) => `positive outcome, ${count} students (${pct}) grasped the lesson content successfully`
        ],
        
        oneMissing: [
            (understood, pctU, notUnd, pctN) => `lesson understood well by ${understood} students (${pctU}) and ${notUnd} student (${pctN}) was given additional exercise for practice`,
            (understood, pctU, notUnd, pctN) => `${understood} students (${pctU}) showed good understanding, ${notUnd} student (${pctN}) will receive extra support`,
            (understood, pctU, notUnd, pctN) => `good comprehension by ${understood} students (${pctU}), ${notUnd} student (${pctN}) requires additional practice`,
            (understood, pctU, notUnd, pctN) => `positive results: ${understood} students (${pctU}) understood, ${notUnd} student (${pctN}) will be given remedial work`,
            (understood, pctU, notUnd, pctN) => `lesson went well for ${understood} students (${pctU}), but ${notUnd} student (${pctN}) needs further assistance`
        ],
        
        multipleMissing: [
            (understood, pctU, notUnd, pctN) => `lesson understood well by ${understood} students (${pctU}) and ${notUnd} students (${pctN}) were given additional exercises for practice`,
            (understood, pctU, notUnd, pctN) => `${understood} students (${pctU}) showed good understanding, ${notUnd} students (${pctN}) will receive extra support`,
            (understood, pctU, notUnd, pctN) => `good comprehension by ${understood} students (${pctU}), ${notUnd} students (${pctN}) require additional practice`,
            (understood, pctU, notUnd, pctN) => `positive results: ${understood} students (${pctU}) understood, ${notUnd} students (${pctN}) will be given remedial work`,
            (understood, pctU, notUnd, pctN) => `lesson went well for ${understood} students (${pctU}), but ${notUnd} students (${pctN}) need further assistance`,
            (understood, pctU, notUnd, pctN) => `majority ${understood} students (${pctU}) succeeded in understanding, ${notUnd} students (${pctN}) will receive additional learning time`
        ]
    }
};
...
if (parseInt(stdUnderstood) === (parseInt(femalePres) + parseInt(malePres))) {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.swahili.allUnderstood)(underStd, underStdPrc)
        );
    } else if (notUnderstd === 1) {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.swahili.oneMissing)(underStd, underStdPrc, notUnderstd, notUnderstdprs)
        );
    } else {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.swahili.multipleMissing)(underStd, underStdPrc, notUnderstd, notUnderstdprs)
        );
    }
...
remarkComm.innerText = sentenceCase(getRandomElement(remarkPatterns.english)());
 ...
 if (parseInt(stdUnderstood) === (parseInt(femalePres) + parseInt(malePres))) {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.english.allUnderstood)(underStd, underStdPrc)
        );
    } else if (notUnderstd === 1) {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.english.oneMissing)(underStd, underStdPrc, notUnderstd, notUnderstdprs)
        );
    } else {
        lessonComment.innerText = sentenceCase(
            getRandomElement(lessonCommentPatterns.english.multipleMissing)(underStd, underStdPrc, notUnderstd, notUnderstdprs)
        );
    }
