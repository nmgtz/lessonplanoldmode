(function() {
    if ( window.location.href !== "https://www.academixpoint.com/p/create-lesson-plan-old-mode.html#" && window.location.href !== "https://www.academixpoint.com/p/create-lesson-plan-old-mode.html?m=1" && window.location.href !== "https://www.academixpoint.com/p/create-lesson-plan-old-mode.html?m=1#" && window.location.href !== "https://www.academixpoint.com/p/create-lesson-plan-old-mode.html" ) {
...
nmRf.preventDefault();
window.location.href ="https://www.academixpoint.com/p/create-lesson-plan-old-mode.html";
});
html2pdf()
    .from(lessonTemp)
