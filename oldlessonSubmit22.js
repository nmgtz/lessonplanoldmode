...
function buildAndDownloadPdf(filename, onSuccess) {
    ...
    doc.autoTable({
        ...
        styles:{...base, cellPadding:{top:0.7,bottom:0.9,left:1,right:1}, lineWidth:0},
        columnStyles:{0:{fontStyle:'bold',cellWidth:dCW[0],valign:'bottom'},1:{cellWidth:dCW[1],valign:'bottom'},
                      2:{fontStyle:'bold',cellWidth:dCW[2],valign:'bottom'},3:{cellWidth:dCW[3],valign:'bottom'}},
        body:[
    ...
    doc.autoTable({
        startY:y, margin:{left:ML,right:MR}, tableWidth:CW, theme:'plain',
        pageBreak:'avoid', rowPageBreak:'avoid',
        styles:{...base, fontSize:7.6, cellPadding:{top:0.5,bottom:0.6,left:1,right:1}, lineWidth:0},
        columnStyles:{0:{fontStyle:'bold',cellWidth:compLblW,valign:'bottom'},1:{cellWidth:CW-compLblW,valign:'bottom'}},
        body:[
