...
if (
    ...
    // localStorage functionality - MODIFIED loadSavedData method
    saveFormData() {
        try {
            const formData = {};
            const formElements = this.form.querySelectorAll('input, select');
    ...
    loadSavedData() {
        try {
            ...
            if (savedData) {
                ...
                // Check if saved data is not too old (optional - 7 days)
                ...
                // MODIFIED: Always start at step 1 instead of restoring previous step
                this.currentStep = 1;
                this.updateStep();
...
function loadDataIntoForm(data) {
    try {
        ...
        // **NEW: Restore edited reference if saved**
        const editableRefGroup = document.getElementById('editableRefGroup');
        const editableRefEl = document.getElementById('editableRef');
        const refSelect = document.getElementById('refLesson');
        ...
        if (data.editableRef && data.editableRef.trim()) {
            ...
            // Also set the dropdown to trigger the show
